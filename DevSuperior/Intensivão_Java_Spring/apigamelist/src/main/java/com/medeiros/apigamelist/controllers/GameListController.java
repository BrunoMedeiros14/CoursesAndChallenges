...
import com.medeiros.apigamelist.dto.ReplacementDTO;
...
public class GameListController {
  ...
  public void moveGameInList(
    ...
    @RequestBody ReplacementDTO replacement
  ) {
    gameListService.moveGameInList(
      listId,
      replacement.getSourceIndex(),
      replacement.getDestinationIndex()
    );
  }
}
