...
import com.medeiros.credit.application.system.entity.Address
...
class CustomerServiceTest {
	...
	fun `should not find customer by invalid id and throw BusinessException`() {
		...
		//when
		//then
		Assertions.assertThatExceptionOfType(BusinessException::class.java).isThrownBy { customerService.findById(fakeId) }
